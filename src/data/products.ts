...
export const products: Product[] = [
  // --- Updated and new products from brochure ---
  {
    ...
    price: 28,
    images: [
      "/assets/images/products/liquid-tribe-1_optimized.webp",
      "/assets/images/products/liquid-tribe-2_optimized.webp",
      "/assets/images/products/liquid-tribe-3_optimized.webp",
    ],
    category: "cleansers",
...

  {
    ...
    price: 45,
    images: [
      "/assets/images/products/blackpride-1_optimized.webp",
      "/assets/images/products/blackpride-2_optimized.webp",
      "/assets/images/products/blackpride-3_optimized.webp",
    ],
    category: "soaps",
    tags: [
      "even tone",
...

  {
    ...
    price: 52,
    images: [
      "/assets/images/products/acne-vanish-1_optimized.webp",
      "/assets/images/products/acne-vanish-3_optimized.webp",
      "/assets/images/products/acne-vanish-4_optimized.webp",
    ],
    category: "toners",
...

  {
    ...
    price: 60,
    images: [
      "/assets/images/products/mirabel-juice-1_optimized.webp",
      "/assets/images/products/mirabel-juice-2_optimized.webp",
    ],
    category: "oils",
...

  {
    ...
    price: 40,
    images: [
      "/assets/images/products/shed-it-off-1_optimized.webp",
      "/assets/images/products/shed-it-off-2_optimized.webp",
    ],
    category: "scrubs",
...

  {
    ...
    price: 55,
    images: [
      "/assets/images/products/glittax-milk-1_optimized.webp",
      "/assets/images/products/glittax-milk-2_optimized.webp",
      "/assets/images/products/glittax-milk-3_optimized.webp",
      "/assets/images/products/glittax-milk-4_optimized.webp",
    ],
    category: "creams",
...

  {
    ...
    price: 65,
    images: [
      "/assets/images/products/heal-drops-1_optimized.webp",
      "/assets/images/products/heal-drops-2_optimized.webp",
      "/assets/images/products/heal-drops-3_optimized.webp",
    ],
    category: "serums",
...

  {
    ...
    price: 38,
    images: [
      "/assets/images/products/blackpride-gel-1_optimized.webp",
      "/assets/images/products/blackpride-gel-2_optimized.webp",
    ],
    category: "gels",
...

  {
    ...
    price: 50,
    images: [
      "/assets/images/products/pearl-body-prime-1_optimized.webp",
      "/assets/images/products/pearl-body-prime-2_optimized.webp",
    ],
    category: "creams",
...

  {
    ...
    price: 48,
    images: [
      "/assets/images/products/intense-glow-oil-1_optimized.webp",
      "/assets/images/products/intense-glow-oil-2_optimized.webp",
    ],
    category: "oils",
...

  {
    ...
    price: 54,
    images: [
      "/assets/images/products/forbearance-1_optimized.webp",
      "/assets/images/products/forbearance-2_optimized.webp",
    ],
    category: "creams",
...

  {
    ...
    price: 46,
    images: [
      "/assets/images/products/luminance-1_optimized.webp",
      "/assets/images/products/luminance-2_optimized.webp",
    ],
    category: "creams",
...

  {
    ...
    price: 36,
    images: [
      "/assets/images/products/face-lave-1_optimized.webp",
      "/assets/images/products/face-lave-2_optimized.webp",
    ],
    category: "cleansers",
    tags: ["sensitive skin", "exfoliating", "brightening", "hydrating"],
    stock: 18,
...

  {
    ...
    price: 42,
    images: ["/assets/images/products/tender-moist-toner-1_optimized.webp"],
    category: "toners",
...

  {
    ...
    price: 44,
    images: ["/assets/images/products/acne-vanish-wash-1_optimized.webp"],
    category: "cleansers",
...

  {
    ...
    price: 46,
    images: ["/assets/images/products/acne-vanish-cream-1_optimized.webp"],
    category: "creams",
...

  {
    ...
    price: 22,
    images: ["/assets/images/products/lipentance-1_optimized.webp"],
    category: "balms",
...

  {
    ...
    price: 38,
    images: ["/assets/images/products/mask-it-up-1_optimized.webp"],
    category: "masks",
...

  {
    ...
    price: 48,
    images: ["/assets/images/products/autograph-1_optimized.webp"],
    category: "creams",
...

  {
    ...
    price: 36,
    images: ["/assets/images/products/knuckle-clear-1_optimized.webp"],
    category: "creams",
...

  {
    ...
    price: 42,
    images: ["/assets/images/products/verbiage-1_optimized.webp"],
    category: "creams",
...

  {
    ...
    price: 44,
    images: ["/assets/images/products/forearance-face-1_optimized.webp"],
    category: "creams",
