  ...
  return (
    <div className="container mx-auto px-4 pt-32 pb-12">
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <h1 className="text-3xl font-clash font-bold text-foreground mb-2">
          Checkout
        </h1>
                  ...
                  <div className="bg-white rounded-xl border-0">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        />
                        <div className="relative">
                          <select className="w-full p-2 border border-gray-200 rounded-lg bg-gray-50 appearance-none pr-10 focus:bg-white focus:border-primary">
                            <option>State</option>
                            <option>Lagos</option>
                            <option>Abuja</option>
                          </select>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="border border-gray-200 rounded-lg">
                        <label className="flex items-center justify-between p-4 cursor-pointer">
                          ...
                          <div className="flex gap-2 items-center">
                            <img
                              src="./assets/images/payment_icons/logos_mastercard.svg"
                              alt="Mastercard"
                              className="h-5 w-auto"
                            />
                            <img
                              src="./assets/images/payment_icons/logos_visa.svg"
                              alt="Visa"
                              className="h-5 w-auto"
                            />
                            <img
                              src="./assets/images/payment_icons/Stripe-Logo.png"
                              alt="stripe"
                              className="h-5 w-auto"
                            />
                            <img
                              src="./assets/images/payment_icons/image 90.png"
                      ...
                      <div className="border border-gray-200 rounded-lg">
                        <label className="flex items-center justify-between p-4 cursor-pointer">
                          ...
                          <img
                            src="./assets/images/payment_icons/paypal-logo.webp"
                            alt="PayPal"
                            className="h-5 w-auto"
                          />
                        </label>
                      ...
                      <div className="border border-gray-200 rounded-lg">
                        <label className="flex items-center justify-between p-4 cursor-pointer">
                          ...
                          <img
                            src="./assets/images/payment_icons/flutterwave.png"
                            alt="flutterwave"
                            className="h-5 w-auto"
                          />
                        </label>
