  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <motion.div 
        ...
        transition={{ duration: 0.5 }}
      >
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-quincy mb-4">Get In Touch</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <motion.div
          ...
          className="space-y-8"
        >
          <motion.div variants={fadeIn} className="bg-white rounded-2xl shadow-soft p-8">
            <h2 className="text-2xl font-quincy mb-6">Contact Information</h2>
            
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-gold-light p-4 rounded-full mr-4">
                  <Mail className="text-gold-dark" size={24} />
                </div>
                <div>
                  <h3 className="font-medium mb-1">Email Us</h3>
                  <p className="text-muted-foreground mb-1">For general inquiries:</p>
                  <a href="mailto:hello@omotanwami.com" className="text-gold-dark hover:underline">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-gold-dark hover:underline">
                    +1 (234) 567-890
                  </a>
                </div>
              </div>
          ...
          <motion.div variants={fadeIn} className="bg-gold-light rounded-2xl p-8">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-white p-3 rounded-full hover:bg-gold-medium transition-colors">
          ...
          <div className="bg-white rounded-2xl shadow-soft p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="btn-primary bg-gold-medium hover:bg-gold-dark w-full flex items-center justify-center gap-2"
              >
