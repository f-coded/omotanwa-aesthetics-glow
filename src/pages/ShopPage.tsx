...
const ShopPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-clash mb-4">Our Products</h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Discover our collection of premium skincare products, carefully
          formulated for your skin's unique needs.
        </p>
      </motion.div>
          ...
          >
            <div className="p-6">
              ...
              <div className="flex justify-between">
                ...
                <button className="btn-primary" onClick={toggleMobileFilters}>
                  Apply Filters
                </button>
              </div>
            </div>
